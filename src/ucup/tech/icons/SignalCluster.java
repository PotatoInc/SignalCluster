...
import ucup.tech.icons.misc.Controller;
	...
	private void updateDataNetType(int type){
		if (hasService() && mDataState == TelephonyManager.DATA_CONNECTED) {
			...
			case TelephonyManager.NETWORK_TYPE_EDGE:
				...
				this.mDataIcon.setImageResource(mControl.getDrawableId("stat_sys_data_connected_e"));
				break;
			case  TelephonyManager.NETWORK_TYPE_UMTS:
				makeLog("DATAICON: 3G");
				this.mDataIcon.setImageResource(mControl.getDrawableId("stat_sys_data_connected_3g"));
				break;
			case TelephonyManager.NETWORK_TYPE_HSDPA:
			case TelephonyManager.NETWORK_TYPE_HSUPA:
			case TelephonyManager.NETWORK_TYPE_HSPA:
				makeLog("DATAICON: HSPA");
				this.mDataIcon.setImageResource(mControl.getDrawableId("stat_sys_data_connected_h"));
				break;
			case TelephonyManager.NETWORK_TYPE_GPRS:
				makeLog("DATAICON: GPRS");
				this.mDataIcon.setImageResource(mControl.getDrawableId("stat_sys_data_connected_g"));
				break;
			default:
	...
	private void updateInOutIcon(){
		if (hasService() && mDataState == TelephonyManager.DATA_CONNECTED) {
			...
			case TelephonyManager.DATA_ACTIVITY_IN:
				//makeLog("INOUT: IN");
				this.mInOutIcon.setImageResource(mControl.getDrawableId("stat_sys_signal_in"));
				break;
			case TelephonyManager.DATA_ACTIVITY_OUT:
				//makeLog("INOUT: OUT");
				this.mInOutIcon.setImageResource(mControl.getDrawableId("stat_sys_signal_out"));
				break;
			case TelephonyManager.DATA_ACTIVITY_INOUT:
				//makeLog("INOUT: INOUT");
				this.mInOutIcon.setImageResource(mControl.getDrawableId("stat_sys_signal_inout"));
				break;
			default:
				//makeLog("INOUT: NULL");
				this.mInOutIcon.setImageDrawable(null);
	...
	private void updateSignalIcon(){
		...
		if (mService == null || (!hasService()) ) {
			...
			if (Settings.System.getInt(mContext.getContentResolver(),
				...
				this.mSignalIcon.setImageResource(mControl.getDrawableId("stat_sys_signal_flightmode"));
			} else {
